...
* Author nya Radya, Farid, M.hadi.firmansya,Nazwa, dan WEM
* Tambahin ya zhayank
               ...
               if (data.error) return reply(data.error)
				...
				case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							client.sendMessage(_.jid, buff, image, {caption: `*「 🤖☘️ᴊᴀᴄᴋ BROADCAST🤖☘️ 」*\n\n${body.slice(4)}`})
						}
						reply('')
					} else {
						for (let _ of anu) {
							sendMess(_.jid, `*「 🤖☘️ ᴊᴀᴄᴋ BROADCAST🤖☘ 」*\n\n${body.slice(4)}`)
						}
